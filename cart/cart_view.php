...
<main>
    ...
    <?php if (cart_product_count() == 0) : ?>
        <p>There are no requested rentals in your cart.</p>
    <?php else: ?>
        <p>To remove a requested rental from your cart, change its quantity to 0.</p>
    ...
    <?php if (cart_product_count() > 0) : ?>
        <p>
            Proceed to: <a href="../checkout">Submit your reservation request</a>
        </p>
    <?php endif; ?>
</main>
